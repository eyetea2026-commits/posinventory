...
<body>
    <div class="login-background">
        <section class="login-card">
            ...
            <h1>Cashier Login</h1>
            <p>Sign in to manage sales and inventory from the cashier dashboard.</p>
            ...
            <form method="POST" action="{{ route('cashier.login.post') }}">
                ...
                <div class="login-footer">
                    <span class="forgot-disabled">
                        <i class="fa-solid fa-lock" style="margin-right: 5px;"></i>
                        Password reset available for Administrators only
                    </span>
                    <a class="small-link" href="{{ route('welcome') }}" style="margin-top: 10px; display: block;">&#8592; Back to role selection</a>
                </div>
            </form>
        </section>
    </div>
