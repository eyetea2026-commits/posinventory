...
<head>
    ...
    <title>Cashier Reset Password - CCTV Express TACURONG</title>
...
<body>
    <div class="login-background">
        <section class="login-card">
            ...
            <p>Create a new password for your cashier account.</p>
            ...
            <form method="POST" action="{{ route('cashier.password.reset') }}">
                @csrf
