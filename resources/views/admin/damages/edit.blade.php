...
@section('title', 'Edit Damage Record - CCTV Express')

@section('header')
    <div class="header-title">
        <h1>Edit Damage Record</h1>
        <p>Update this damaged product record</p>
    </div>
@endsection
...
<script>
    ...
    function confirmSave() {
        ...
        Swal.fire({
            ...
            text: 'Are you sure you want to update this damage record?',
            icon: 'question',
