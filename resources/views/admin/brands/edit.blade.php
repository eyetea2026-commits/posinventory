...
@section('title', 'Edit Brand - CCTV Express')

@section('header')
    <div class="header-title">
        <h1>Edit Brand</h1>
        <p>Update the brand name or its assigned category</p>
    </div>
@endsection
...
<style>
    ...
    .btn {
        ...
        transition: all 0.2s ease; border: none; cursor: pointer; font-size: 0.95rem;
    }
    .btn-primary { background: linear-gradient(135deg, var(--primary), var(--success)); color: white; }
    ...
    .form-control {
        ...
        border: 1px solid rgba(59, 130, 246, 0.2); border-radius: 12px; color: #f8fafc; font-size: 1rem;
    }
    .form-control:focus { outline: none; border-color: var(--primary); }
    .error { display: block; margin-top: 8px; color: #fca5a5; font-size: 0.85rem; }
...
<div class="card glass-card">
    <form method="POST" action="{{ route('admin.brands.update', $brand) }}" id="brandForm">
        ...
        @include('admin.brands.partials.brand-form-fields')
